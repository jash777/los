async function testStage2Detailed() {
    try {
        ...
        if (stage2Result.success) {
            ...
            if (stage2Result.reason) {
                console.log('Reason:', stage2Result.reason);
            }
            if (stage2Result.recommendations) {
                console.log('Recommendations:', stage2Result.recommendations);
            }
        }
